export default {
  es: {
    translation: {
      jobTitleHome: 'Ingeniero Full Stack',
      name: 'Jonathan Díaz',
      ...
      jobExperience:
        'Más de 8 años de experiencia trabajando en medios de comunicación y consultoría de software para varios clientes',
      bodyHome:
      ...
      programmingLanguage: 'Lenguajes de Programación',
      servers: 'Servidores',
      front: 'Front-End',
      back: 'Back-End',
